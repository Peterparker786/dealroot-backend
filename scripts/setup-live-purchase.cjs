...
async function main() {
  ...
  const email = `livep-${uniq}@example.com`;
  ...
  await api("/tryouts/apply", { method: "POST", body: { name, phone, city: "Kanpur", state: "Uttar Pradesh", pincode: "208001", previousProgram: "Other", otherProgram: "Test", reason: "live" } }, userToken);
